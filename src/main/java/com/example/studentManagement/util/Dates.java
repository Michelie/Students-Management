...
public class Dates {
    ...
    public static Date atUtc(LocalDateTime date, TimeZone zone) {//returns date of server
    ...
    public static LocalDateTime atLocalTime(Date date, TimeZone zone) {//returns local time
        if (date == null) return null;
